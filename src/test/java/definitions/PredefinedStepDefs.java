...
public class PredefinedStepDefs {
    ...
    public static void iOpenUrl(String url) {
        getDriver().get(url);
    }
    ...
    public static void iWaitForSec(int sec) throws Exception {
    ...
    public static void elementWithXpathShouldBePresent(String xpath) {
        assertThat(getDriver().findElements(By.xpath(xpath))).hasSize(1);
    }

    @Then("element with xpath {string} should not be present")
    public static void elementWithXpathShouldNotBePresent(String xpath) {
    ...
    public static void iClickOnElementUsingJavaScriptWithXpath(String xpath) {
    ...
    public static void iTakeScreenshot() throws Exception {
    ...
    public static void elementWithXpathShouldHaveTextAs(String xpath, String text) {
        String actualText = getDriver().findElement(By.xpath(xpath)).getText();
        assertThat(actualText).isEqualTo(text);
    }

    @Then("element with xpath {string} should not have text as {string}")
    public static void elementWithXpathShouldNotHaveTextAs(String xpath, String text) {
        String actualText = getDriver().findElement(By.xpath(xpath)).getText();
        assertThat(actualText).isNotEqualTo(text);
    }

    @Then("element with xpath {string} should contain text {string}")
    public static void elementWithXpathShouldContainText(String xpath, String text) {
        String actualText = getDriver().findElement(By.xpath(xpath)).getText();
        // String textContent = getDriver().findElement(By.xpath(xpath)).getAttribute("textContent");
        // String innerHTML = getDriver().findElement(By.xpath(xpath)).getAttribute("innerHTML");
        assertThat(actualText).containsIgnoringCase(text);
    }

    @Then("element with xpath {string} should not contain text {string}")
    public static void elementWithXpathShouldNotContainText(String xpath, String text) {
        String actualText = getDriver().findElement(By.xpath(xpath)).getText();
        assertThat(actualText).doesNotContain(text);
    }

    @Then("element with xpath {string} should have attribute {string} as {string}")
    public static void elementWithXpathShouldHaveAttributeAs(String xpath, String attribute, String attributeValue) {
        String value = getDriver().findElement(By.xpath(xpath)).getAttribute(attribute);
    ...
    public static void elementWithXpathShouldNotHaveAttributeAs(String xpath, String attribute, String attributeValue) {
    ...
    public static void iSwitchToIframeWithXpath(String xpath) {
        getDriver().switchTo().frame(getDriver().findElement(By.xpath(xpath)));
    }

    @Then("I switch to default content")
    public static void iSwitchToDefaultContent() {
        getDriver().switchTo().defaultContent();
    }

    @Then("I switch to new window")
    public static void iSwitchToNewWindow() {
    ...
    public static void iMouseOverElementWithXpath(String xpath) {
