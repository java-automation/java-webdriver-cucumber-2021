...
public class ConverterStepdefs {
    ...
    public void iVerifyConversionResult(String expectedResult) throws InterruptedException {
...
//        String roundedExpectedResult = decimalFormat.format(Double.parseDouble(expectedResult));
