...
Feature: Smoke steps
  ...
  Scenario: Predefined steps for Gibiru
    ...
    Then I wait for element with xpath "//div[@class='gsc-webResult gsc-result'][last()]" to be present
    Then I wait for 3 sec
  ...
  Scenario: Predefined steps for SwissCows
    ...
    When I click on element with xpath "//form/button"
  ...
  Scenario: Predefined steps for Startpage
    ...
    Then element with xpath "//form[@id='search']/input[@id='q']" should be present
    When I type "Behavior Driven Development" into element with xpath "//form[@id='search']/input[@id='q']"
    When I click on element with xpath "//form[@id='search']/button[@type='submit']"
    Then I wait for element with xpath "//div[@class='layout-web__body layout-web__body--desktop']" to be present
    Then I wait for 3 sec
    Then element with xpath "//div[@class='layout-web__body layout-web__body--desktop']" should contain text "Cucumber"

  @predefined9
  Scenario: Predefined steps for Yandex
    Given I open url "https://yandex.com/"
    Then I should see page title contains "Yandex"
    Then element with xpath "//input[@aria-label='Request']" should be present
  ...
  Scenario: Predefined steps for Ecosia
    ...
    @predefined_lab2
    Scenario: validate minimal length username
      Given I open url "https://skryabin.com/market/quote.html"
    ...
    Scenario: validate email field accepts only valid email addresses
      Given I open url "https://skryabin.com/market/quote.html"
      When I type "aaa.com" into element with xpath "//input[@name='email']"
      ...
      And I type "aaa@gmail.com" into element with xpath "//input[@name='email']"
    ...
    Scenario: Validate that Confirm Password is disabled if Password field is empty
      ...
      When I type "qwerty" into element with xpath "//input[@name='password']"
      And I type "qwert" into element with xpath "//input[@name='confirmPassword']"
      And I click on element with xpath "//button[@id='formSubmit']"
    ...
    Scenario: validate name field behavior
      ...
      And I type "Jack" into element with xpath "//input[@id='middleName']"
      And I type "Snow" into element with xpath "//input[@id='lastName']"
      And I click on element with xpath "//span[contains(text(),'Save')]"
      Then element with xpath "//input[@id='name']" should have attribute "value" as "John Jack Snow"
    ...
    @predefined_lab7
    Scenario:  entering non-required fields in the particular order
      Given I open url "https://skryabin.com/market/quote.html"
      When I type "8888888888" into element with xpath "//input[@name='phone']"
      ...
      And I type "Beverly Hills, 90210" into element with xpath "//textarea[@name='address']"
    ...
    @predefined_lab8
    Scenario: validate fields values are present after submission and that password is not displayed
      Given I open url "https://skryabin.com/market/quote.html"
      ...
      And I type "Snow" into element with xpath "//input[@id='lastName']"
      And I click on element with xpath "//span[contains(text(),'Save')]"
      And I type "name1" into element with xpath "//input[@name='username']"
      And I type "name@gmail.com" into element with xpath "//input[@name='email']"
      ...
      Then element with xpath "//b[@name='lastName']" should contain text "Snow"
      Then element with xpath "//b[@name='name']" should contain text "John Snow"
      Then element with xpath "//b[@name='username']" should contain text "name1"
      Then element with xpath "//b[@name='email']" should contain text "name@gmail.com"
      Then element with xpath "//b[@name='password']" should not contain text "qwerty"
